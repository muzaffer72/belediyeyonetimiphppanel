...
--
-- Name: approve_discover_post(uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.approve_discover_post(post_id uuid) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
  ...
  SET is_approved = true, 
      updated_at = NOW() 
  WHERE id = post_id AND type = 'discover';
...
ALTER FUNCTION public.approve_discover_post(post_id uuid) OWNER TO supabase_admin;

--
-- Name: auto_approve_discover_posts(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.auto_approve_discover_posts() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  IF NEW.type = 'discover' AND NEW.auto_approve = true THEN
...
ALTER FUNCTION public.auto_approve_discover_posts() OWNER TO supabase_admin;
...
--
-- Name: calculate_poll_total_votes(uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    total_votes INTEGER;
BEGIN
    SELECT COALESCE(SUM(vote_count), 0) INTO total_votes
    FROM poll_options 
...
ALTER FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) OWNER TO supabase_admin;
...
--
-- Name: create_like_notification(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
BEGIN
  ...
  -- Eğer kendi gönderisini beğeniyorsa bildirim oluşturma
  IF v_post_owner_id = NEW.user_id THEN
    RETURN NEW;
  END IF;
  
  -- Beğenen kullanıcı bilgilerini al
  SELECT username, profile_image_url INTO v_liker_name, v_liker_profile_url 
  FROM public.users 
  WHERE id = NEW.user_id;
  ...
  INSERT INTO public.notifications (
    ...
    COALESCE(v_liker_name, 'Bir kullanıcı') || ' "' || COALESCE(SUBSTRING(v_post_title FROM 1 FOR 30), 'Gönderinizi') || '..." gönderinizi beğendi',
    'like',
    NEW.user_id,
    v_liker_name,
    v_liker_profile_url,
...
ALTER FUNCTION public.create_like_notification() OWNER TO supabase_admin;
...
CREATE TABLE public.posts (
    ...
    CONSTRAINT posts_type_check CHECK ((type = ANY (ARRAY['complaint'::text, 'suggestion'::text, 'thanks'::text, 'discover'::text])))
);
...
--
-- Name: get_pending_discover_posts(integer, integer); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.get_pending_discover_posts(limit_val integer DEFAULT 20, offset_val integer DEFAULT 0) RETURNS TABLE(id uuid, user_id uuid, title text, description text, media_url text, is_video boolean, type text, category text, city text, district text, created_at timestamp with time zone, updated_at timestamp with time zone, auto_approve boolean, is_approved boolean)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
  SELECT p.id, p.user_id, p.title, p.description,
         p.media_url, (p.is_video)::BOOLEAN, p.type, p.category,
         p.city, p.district, p.created_at, p.updated_at,
         COALESCE(p.auto_approve, false) as auto_approve,
         COALESCE(p.is_approved, false) as is_approved
  FROM posts p
  WHERE p.type = 'discover' AND COALESCE(p.is_approved, false) = false
...
ALTER FUNCTION public.get_pending_discover_posts(limit_val integer, offset_val integer) OWNER TO supabase_admin;
...
--
-- Name: increment_ad_clicks(uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.increment_ad_clicks(ad_id_param uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.increment_ad_clicks(ad_id_param uuid) OWNER TO supabase_admin;

--
-- Name: increment_ad_impressions(uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.increment_ad_impressions(ad_id_param uuid) OWNER TO supabase_admin;
...
--
-- Name: insert_comment_safe(uuid, uuid, uuid, text, boolean); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean DEFAULT false) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Doğrudan INSERT yap
  INSERT INTO comments (
    id, post_id, user_id, content, is_anonymous, status, created_at, updated_at
  ) VALUES (
    comment_id,
    post_id_param,
    user_id_param,
  ...
  -- Manuel olarak yorum sayısını artır
  UPDATE posts 
  SET comment_count = comment_count + 1 
  WHERE id = post_id_param;
END;
...
ALTER FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean) OWNER TO supabase_admin;

--
-- Name: insert_like_safe(uuid, uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
  like_exists BOOLEAN;
...
BEGIN
  ...
  IF NOT like_exists THEN
    ...
    -- Manuel olarak beğeni sayısını artır
    UPDATE posts 
    SET like_count = like_count + 1 
    WHERE id = post_id_param;
  END IF;
...
ALTER FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) OWNER TO supabase_admin;
...
--
-- Name: set_auto_approve(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.set_auto_approve() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- posts tablosuna insert edilirken, users tablosundaki auto_approve değerini al
  NEW.auto_approve := (SELECT auto_approve FROM users WHERE id = NEW.user_id);
  RETURN NEW;
END;
$$;


ALTER FUNCTION public.set_auto_approve() OWNER TO supabase_admin;
...
--
-- Name: update_auto_approve_fields(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.update_auto_approve_fields() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Kullanıcıdan auto_approve bilgisi al
  SELECT auto_approve INTO NEW.auto_approve
  FROM users
  WHERE id = NEW.user_id;

  -- Eğer kullanıcıda auto_approve TRUE ise, is_approved da TRUE olsun
  IF NEW.auto_approve = true THEN
    NEW.is_approved := true;
  ELSE
...
ALTER FUNCTION public.update_auto_approve_fields() OWNER TO supabase_admin;
...
--
-- Name: update_poll_vote_counts(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        new_option_id := NEW.option_id;
        
        -- Yeni seçenek için oy sayısını artır
        UPDATE poll_options 
    ...
    -- UPDATE işlemi (oy değiştirme)
    IF TG_OP = 'UPDATE' THEN
        old_option_id := OLD.option_id;
        new_option_id := NEW.option_id;
        
        -- Eğer seçenek değişmişse
        IF old_option_id != new_option_id THEN
            -- Eski seçenekten oy sayısını azalt
            UPDATE poll_options 
            SET vote_count = vote_count - 1 
            WHERE id = old_option_id;
            
            -- Yeni seçeneğe oy sayısını artır
            UPDATE poll_options 
            SET vote_count = vote_count + 1 
            WHERE id = new_option_id;
        END IF;
    ...
    IF TG_OP = 'DELETE' THEN
        ...
        -- Silinen oyun seçeneğinden oy sayısını azalt
        UPDATE poll_options 
        SET vote_count = vote_count - 1 
        WHERE id = old_option_id;
...
ALTER FUNCTION public.update_poll_vote_counts() OWNER TO supabase_admin;
...
--
-- Name: contact_request_responses; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE public.contact_request_responses (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.contact_request_responses OWNER TO supabase_admin;

--
-- Name: contact_requests; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
CREATE TABLE public.contact_requests (
    ...
    CONSTRAINT contact_requests_request_type_check CHECK (((request_type)::text = ANY ((ARRAY['sorun'::character varying, 'oneri'::character varying, 'reklam'::character varying])::text[]))),
    CONSTRAINT contact_requests_status_check CHECK (((status)::text = ANY ((ARRAY['open'::character varying, 'closed'::character varying])::text[])))
);


ALTER TABLE public.contact_requests OWNER TO supabase_admin;
...
--
-- Name: event_info; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.event_info OWNER TO supabase_admin;

--
-- Name: COLUMN event_info.event_price; Type: COMMENT; Schema: public; Owner: supabase_admin
--

COMMENT ON COLUMN public.event_info.event_price IS 'Etkinlik ücreti bilgisi (örn: "50 TL", "Ücretsiz", "100-200 TL arası")';
...
--
-- Name: legal_documents; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
CREATE TABLE public.legal_documents (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT legal_documents_type_check CHECK ((type = ANY (ARRAY['privacy_policy'::text, 'terms_of_service'::text])))
);


ALTER TABLE public.legal_documents OWNER TO supabase_admin;
...
--
-- Name: place_info; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE public.place_info (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    post_id uuid,
    camping_suitable boolean DEFAULT false,
...
ALTER TABLE public.place_info OWNER TO supabase_admin;

--
-- Name: COLUMN place_info.place_price; Type: COMMENT; Schema: public; Owner: supabase_admin
--

COMMENT ON COLUMN public.place_info.place_price IS 'Gezilecek yer giriş ücreti (örn: "25 TL", "Ücretsiz", "Çocuk 10 TL, Yetişkin 20 TL")';
...
CREATE TABLE public.polls (
    ...
    level character varying(20) DEFAULT 'country'::character varying,
...
CREATE TABLE public.sponsored_ads (
    ...
    CONSTRAINT sponsored_ads_ad_display_scope_check CHECK ((ad_display_scope = ANY (ARRAY['il'::text, 'ilce'::text, 'splash'::text, 'ililce'::text, 'herkes'::text]))),
...
--
-- Name: user_consents; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.user_consents OWNER TO supabase_admin;
...
CREATE TABLE public.users (
    ...
    profile_image_url text DEFAULT 'https://bimer.onvao.net:8443/storage/v1/object/public/profilresimleri/user.png'::text,
    city text NOT NULL,
    district text NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT users_gender_check CHECK ((gender = ANY (ARRAY['Erkek'::text, 'Kadın'::text, 'Belirtmek İstemiyorum'::text])))
);
...
--
-- Name: contact_request_responses contact_request_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.contact_request_responses
    ADD CONSTRAINT contact_request_responses_pkey PRIMARY KEY (id);


--
-- Name: contact_requests contact_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: event_info event_info_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: legal_documents legal_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: place_info place_info_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.place_info
    ADD CONSTRAINT place_info_pkey PRIMARY KEY (id);
...
--
-- Name: user_consents user_consents_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_contact_requests_created_at; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_contact_requests_request_type; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX idx_contact_requests_request_type ON public.contact_requests USING btree (request_type);


--
-- Name: idx_contact_requests_status; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_contact_requests_user_id; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_contact_responses_request_id; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX idx_contact_responses_request_id ON public.contact_request_responses USING btree (request_id);


--
-- Name: idx_event_info_post_id; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX idx_event_info_post_id ON public.event_info USING btree (post_id);


--
-- Name: idx_legal_documents_type; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_place_info_post_id; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX idx_place_info_post_id ON public.place_info USING btree (post_id);
...
--
-- Name: idx_user_consents_user_id; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_users_age; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_users_full_name; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_users_gender; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: posts_discover_approval_idx; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX posts_discover_approval_idx ON public.posts USING btree (type, is_approved) WHERE (type = 'discover'::text);


--
-- Name: posts_discover_category_idx; Type: INDEX; Schema: public; Owner: supabase_admin
--

CREATE INDEX posts_discover_category_idx ON public.posts USING btree (type, category) WHERE (type = 'discover'::text);
...
--
-- Name: likes after_like_insert; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER after_like_insert AFTER INSERT ON public.likes FOR EACH ROW EXECUTE FUNCTION public.create_like_notification();


--
-- Name: comments create_comment_notification_trigger; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER create_comment_notification_trigger AFTER INSERT ON public.comments FOR EACH ROW EXECUTE FUNCTION public.create_comment_notification();


--
-- Name: likes create_like_notification_trigger; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER create_like_notification_trigger AFTER INSERT ON public.likes FOR EACH ROW EXECUTE FUNCTION public.create_like_notification();


--
-- Name: posts discover_post_auto_approve_trigger; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER discover_post_auto_approve_trigger BEFORE INSERT OR UPDATE ON public.posts FOR EACH ROW EXECUTE FUNCTION public.auto_approve_discover_posts();
...
--
-- Name: poll_votes poll_vote_count_update; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER poll_vote_count_update AFTER INSERT OR DELETE OR UPDATE ON public.poll_votes FOR EACH ROW EXECUTE FUNCTION public.update_poll_vote_counts();
...
--
-- Name: posts trg_auto_approve_posts; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER trg_auto_approve_posts BEFORE INSERT ON public.posts FOR EACH ROW EXECUTE FUNCTION public.update_auto_approve_fields();


--
-- Name: posts trg_set_auto_approve; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER trg_set_auto_approve BEFORE INSERT ON public.posts FOR EACH ROW EXECUTE FUNCTION public.set_auto_approve();
...
--
-- Name: contact_request_responses contact_request_responses_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.contact_request_responses
    ADD CONSTRAINT contact_request_responses_admin_id_fkey FOREIGN KEY (admin_id) REFERENCES public.users(id);


--
-- Name: contact_request_responses contact_request_responses_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.contact_request_responses
    ADD CONSTRAINT contact_request_responses_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.contact_requests(id);


--
-- Name: contact_requests contact_requests_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.contact_requests
    ADD CONSTRAINT contact_requests_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: event_info event_info_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.event_info
    ADD CONSTRAINT event_info_post_id_fkey FOREIGN KEY (post_id) REFERENCES public.posts(id) ON DELETE CASCADE;
...
--
-- Name: poll_votes fk_poll_votes_option_id; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.poll_votes
    ADD CONSTRAINT fk_poll_votes_option_id FOREIGN KEY (option_id) REFERENCES public.poll_options(id) ON DELETE CASCADE;


--
-- Name: poll_votes fk_poll_votes_poll_id; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.poll_votes
    ADD CONSTRAINT fk_poll_votes_poll_id FOREIGN KEY (poll_id) REFERENCES public.polls(id) ON DELETE CASCADE;


--
-- Name: poll_votes fk_poll_votes_user_id; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.poll_votes
    ADD CONSTRAINT fk_poll_votes_user_id FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: place_info place_info_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.place_info
    ADD CONSTRAINT place_info_post_id_fkey FOREIGN KEY (post_id) REFERENCES public.posts(id) ON DELETE CASCADE;
...
--
-- Name: user_consents user_consents_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.user_consents
    ADD CONSTRAINT user_consents_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.legal_documents(id);


--
-- Name: user_consents user_consents_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: posts Herkes onaylanmış keşfet gönderilerini görebilir; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Herkes onaylanmış keşfet gönderilerini görebilir" ON public.posts FOR SELECT USING (((type <> 'discover'::text) OR ((type = 'discover'::text) AND (is_approved = true)) OR ((type = 'discover'::text) AND (user_id = auth.uid()))));
...
--
-- Name: posts Kullanıcılar kendi gönderilerini güncelleyebilir; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Kullanıcılar kendi gönderilerini güncelleyebilir" ON public.posts FOR UPDATE USING ((auth.uid() = user_id));


--
-- Name: posts Kullanıcılar kendi gönderilerini oluşturabilir; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Kullanıcılar kendi gönderilerini oluşturabilir" ON public.posts FOR INSERT TO authenticated WITH CHECK ((auth.uid() = user_id));


--
-- Name: posts Kullanıcılar kendi gönderilerini silebilir; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Kullanıcılar kendi gönderilerini silebilir" ON public.posts FOR DELETE USING ((auth.uid() = user_id));
...
--
-- Name: posts Onaylanmış Keşfet içeriklerini göster; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Onaylanmış Keşfet içeriklerini göster" ON public.posts FOR SELECT USING (((type <> 'discover'::text) OR ((type = 'discover'::text) AND (is_approved = true)) OR ((type = 'discover'::text) AND (user_id = auth.uid())) OR ((auth.role() = 'admin'::text) OR (auth.role() = 'service_role'::text))));


--
-- Name: posts Yöneticiler tüm gönderilere erişebilir; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Yöneticiler tüm gönderilere erişebilir" ON public.posts TO service_role USING (true);
...
--
-- Name: event_info; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public.event_info ENABLE ROW LEVEL SECURITY;

--
-- Name: event_info event_info_delete_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY event_info_delete_policy ON public.event_info FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = event_info.post_id) AND (posts.user_id = auth.uid())))));


--
-- Name: event_info event_info_insert_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY event_info_insert_policy ON public.event_info FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = event_info.post_id) AND (posts.user_id = auth.uid())))));


--
-- Name: event_info event_info_select_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY event_info_select_policy ON public.event_info FOR SELECT USING (true);


--
-- Name: event_info event_info_update_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY event_info_update_policy ON public.event_info FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = event_info.post_id) AND (posts.user_id = auth.uid())))));
...
--
-- Name: place_info; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public.place_info ENABLE ROW LEVEL SECURITY;

--
-- Name: place_info place_info_delete_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY place_info_delete_policy ON public.place_info FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = place_info.post_id) AND (posts.user_id = auth.uid())))));


--
-- Name: place_info place_info_insert_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY place_info_insert_policy ON public.place_info FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = place_info.post_id) AND (posts.user_id = auth.uid())))));


--
-- Name: place_info place_info_select_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY place_info_select_policy ON public.place_info FOR SELECT USING (true);


--
-- Name: place_info place_info_update_policy; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY place_info_update_policy ON public.place_info FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.posts
  WHERE ((posts.id = place_info.post_id) AND (posts.user_id = auth.uid())))));
...
--
-- Name: FUNCTION approve_discover_post(post_id uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.approve_discover_post(post_id uuid) TO postgres;
GRANT ALL ON FUNCTION public.approve_discover_post(post_id uuid) TO anon;
GRANT ALL ON FUNCTION public.approve_discover_post(post_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.approve_discover_post(post_id uuid) TO service_role;


--
-- Name: FUNCTION auto_approve_discover_posts(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.auto_approve_discover_posts() TO postgres;
GRANT ALL ON FUNCTION public.auto_approve_discover_posts() TO anon;
GRANT ALL ON FUNCTION public.auto_approve_discover_posts() TO authenticated;
GRANT ALL ON FUNCTION public.auto_approve_discover_posts() TO service_role;
...
--
-- Name: FUNCTION calculate_poll_total_votes(poll_uuid uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) TO postgres;
GRANT ALL ON FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) TO anon;
GRANT ALL ON FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) TO authenticated;
GRANT ALL ON FUNCTION public.calculate_poll_total_votes(poll_uuid uuid) TO service_role;
...
--
-- Name: FUNCTION create_like_notification(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.create_like_notification() TO postgres;
...
--
-- Name: FUNCTION get_pending_discover_posts(limit_val integer, offset_val integer); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.get_pending_discover_posts(limit_val integer, offset_val integer) TO postgres;
GRANT ALL ON FUNCTION public.get_pending_discover_posts(limit_val integer, offset_val integer) TO anon;
GRANT ALL ON FUNCTION public.get_pending_discover_posts(limit_val integer, offset_val integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_pending_discover_posts(limit_val integer, offset_val integer) TO service_role;
...
--
-- Name: FUNCTION increment_ad_clicks(ad_id_param uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.increment_ad_clicks(ad_id_param uuid) TO postgres;
GRANT ALL ON FUNCTION public.increment_ad_clicks(ad_id_param uuid) TO anon;
GRANT ALL ON FUNCTION public.increment_ad_clicks(ad_id_param uuid) TO authenticated;
GRANT ALL ON FUNCTION public.increment_ad_clicks(ad_id_param uuid) TO service_role;


--
-- Name: FUNCTION increment_ad_impressions(ad_id_param uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.increment_ad_impressions(ad_id_param uuid) TO postgres;
GRANT ALL ON FUNCTION public.increment_ad_impressions(ad_id_param uuid) TO anon;
GRANT ALL ON FUNCTION public.increment_ad_impressions(ad_id_param uuid) TO authenticated;
GRANT ALL ON FUNCTION public.increment_ad_impressions(ad_id_param uuid) TO service_role;
...
--
-- Name: FUNCTION insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean) TO postgres;
GRANT ALL ON FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean) TO anon;
GRANT ALL ON FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean) TO authenticated;
GRANT ALL ON FUNCTION public.insert_comment_safe(comment_id uuid, post_id_param uuid, user_id_param uuid, content_param text, is_anonymous_param boolean) TO service_role;


--
-- Name: FUNCTION insert_like_safe(post_id_param uuid, user_id_param uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) TO postgres;
GRANT ALL ON FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) TO anon;
GRANT ALL ON FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) TO authenticated;
GRANT ALL ON FUNCTION public.insert_like_safe(post_id_param uuid, user_id_param uuid) TO service_role;
...
--
-- Name: FUNCTION set_auto_approve(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.set_auto_approve() TO postgres;
GRANT ALL ON FUNCTION public.set_auto_approve() TO anon;
GRANT ALL ON FUNCTION public.set_auto_approve() TO authenticated;
GRANT ALL ON FUNCTION public.set_auto_approve() TO service_role;
...
--
-- Name: FUNCTION update_auto_approve_fields(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.update_auto_approve_fields() TO postgres;
GRANT ALL ON FUNCTION public.update_auto_approve_fields() TO anon;
GRANT ALL ON FUNCTION public.update_auto_approve_fields() TO authenticated;
GRANT ALL ON FUNCTION public.update_auto_approve_fields() TO service_role;
...
--
-- Name: FUNCTION update_poll_vote_counts(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.update_poll_vote_counts() TO postgres;
...
--
-- Name: TABLE contact_request_responses; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.contact_request_responses TO postgres;
GRANT ALL ON TABLE public.contact_request_responses TO anon;
GRANT ALL ON TABLE public.contact_request_responses TO authenticated;
GRANT ALL ON TABLE public.contact_request_responses TO service_role;


--
-- Name: TABLE contact_requests; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.contact_requests TO postgres;
...
--
-- Name: TABLE event_info; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.event_info TO postgres;
...
--
-- Name: TABLE legal_documents; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.legal_documents TO postgres;
...
--
-- Name: TABLE place_info; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.place_info TO postgres;
GRANT ALL ON TABLE public.place_info TO anon;
GRANT ALL ON TABLE public.place_info TO authenticated;
GRANT ALL ON TABLE public.place_info TO service_role;
...
--
-- Name: TABLE user_consents; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.user_consents TO postgres;
